...
<body style="background:url(/static/uimaker/images/topbg.gif) repeat-x;">
    ...
    <ul class="nav">
    <li><a href="default.html" target="rightFrame" class="selected"><img src="/static/uimaker/images/icon01.png" title="工作台" /><h2>工作台</h2></a></li>
    ...
    <div class="topright">    
    <ul>
    <li><span><img src="/static/uimaker/images/help.png" title="帮助"  class="helpimg"/></span><a href="#">帮助</a></li>
    <li><a href="#">关于</a></li>
