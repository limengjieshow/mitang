...
<body>
    ...
    <li><img src="/static/uimaker/images/ico01.png" /><p><a href="#">管理设置</a></p></li>
    <li><img src="/static/uimaker/images/ico02.png" /><p><a href="#">发布文章</a></p></li>
    <li><img src="/static/uimaker/images/ico03.png" /><p><a href="#">数据统计</a></p></li>
    <li><img src="/static/uimaker/images/ico04.png" /><p><a href="#">文件上传</a></p></li>
    <li><img src="/static/uimaker/images/ico05.png" /><p><a href="#">目录管理</a></p></li>
    <li><img src="/static/uimaker/images/ico06.png" /><p><a href="#">查询</a></p></li> 
            
    </ul>
    
    <div class="ibox"><a class="ibtn"><img src="/static/uimaker/images/iadd.png" />添加新的快捷功能</a></div>
    
    <div class="xline"></div>
    <div class="box"></div>
    
    <div class="welinfo">
    <span><img src="/static/uimaker/images/dp.png" alt="提醒" /></span>
