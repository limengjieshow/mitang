	...
	<input class="currentPage" style="display:none;" value="${t_user_page.pageNumber}">
	<#include "../common/_paginate_ajax.ftl" />
	<@paginate currentPage=t_user_page.pageNumber totalPage=t_user_page.totalPage href_str="t_userPage" />